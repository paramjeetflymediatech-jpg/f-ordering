...
import { ArrowLeft, User, Phone, Mail, Lock, Sparkles, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <div className="text-center">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-cyan-500/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-cyan-400 border border-cyan-500/20">
            <Sparkles className="h-3.5 w-3.5" /> Customer Registration
          </span>
          <h2 className="mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">
            Create Your Profile
          </h2>
          <p className="mt-2 text-sm text-slate-400">
            Join to view your order history, payment records, and earn loyalty benefits.
          </p>
        </div>
      </div>
          ...
          {success ? (
            <div className="text-center py-6 space-y-4">
              ...
              <p className="text-sm text-slate-400">
                Redirecting you to the customer login portal...
              </p>
            </div>
          ) : (
