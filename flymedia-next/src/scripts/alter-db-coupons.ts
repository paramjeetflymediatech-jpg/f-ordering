...
async function runAlterCouponsMigration() {
  console.log('--- Dynamic Coupons Alteration Script ---');
  ...
  try {
    ...
    console.log('✅ Central Database coupons alteration complete.');
  } catch (err: any) {
    console.error('❌ Failed to alter Central Database coupons:', err.message);
  }
  ...
  console.log('\n--- Coupons Alteration Script Complete ---');
  process.exit(0);
}

runAlterCouponsMigration();
